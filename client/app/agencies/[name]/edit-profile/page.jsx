    ...
    <div className="flex items-start h-[100vh]">
      ...
      <div className="w-[87%] px-10 mainPageBg h-full">
        ...
        <div className="flex items-start justify-between mt-3 text-white bg-main p-3">
          ...
          <div className="w-[69%]">
            <AgencyDetailsTopbar />
            <div className="border border-gray-200/30 h-[77.4vh] rounded-lg px-6 py-4 flex flex-col justify-between">
              <div>
                <h4 className="mainText18">Agency Details</h4>
              ...
              <div>
                {" "}
                <h4 className="mainText18 mt-5">Key Contact Information</h4>
                <div className="flex items-start justify-between mt-4">
                  <div className="flex items-center justify-center w-3/12">
                    <div className="relative w-6/12 flex items-center justify-center">
                      <div
              ...
              <div className="flex items-center justify-end">
                {" "}
                <button
                  className={`bg-red-600 font-semibold px-7 py-2 rounded-md flex items-center ml-4`}
                  onClick={() => {}}
                >
